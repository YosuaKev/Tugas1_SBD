...
CREATE TABLE  WF_LANGUAGES
   (`LANGUAGE_ID` SMALLINT, 
	...
	/* Name ignored: CONSTRAINT `WF_LANG_PK` */ PRIMARY KEY (`LANGUAGE_ID`)
   );

--  SQLINES DEMO *** gions table
CREATE TABLE  WF_WORLD_REGIONS
   (`REGION_ID` SMALLINT, 
	`REGION_NAME` VARCHAR(35) /* CONSTRAINT "WF_REG_REGNAME_NN" */ NOT NULL, 
	/* Name ignored: CONSTRAINT `WF_REG_PK` */ PRIMARY KEY (`REGION_ID`)
   );
...
CREATE TABLE  WF_COUNTRIES
   (`COUNTRY_ID` SMALLINT, 
	...
	/* Name ignored: CONSTRAINT `WF_CRTY_PK` */ PRIMARY KEY (`COUNTRY_ID`)
   );
...
-- SQLINES DEMO *** languages table
CREATE TABLE  WF_SPOKEN_LANGUAGES
   (`COUNTRY_ID` SMALLINT, 
	`LANGUAGE_ID` SMALLINT, 
	`OFFICIAL` VARCHAR(2), 
	`COMMENTS` VARCHAR(512), 
	/* Name ignored: CONSTRAINT `WF_SPOKEN_LANG_PK` */ PRIMARY KEY (`COUNTRY_ID`, `LANGUAGE_ID`)
   );
-- Ad... SQLINES DEMO ***
...
CREATE TABLE  `F_CUSTOMERS`
   (`ID` INT,
    ...
    `ZIP` BIGINT /* CONSTRAINT "F_CSR_ZIP_NN" */ NOT NULL,
    `PHONE_NUMBER` VARCHAR(10) /* CONSTRAINT "F_CSR_PHONE_NUMB_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_CSR_ID_PK` */ PRIMARY KEY (`ID`)
   );

CREATE TABLE  `F_PROMOTIONAL_MENUS`
   (`CODE` VARCHAR(3),
    `NAME` VARCHAR(30) /* CONSTRAINT "F_PMU_NAME_NN" */ NOT NULL,
    `START_DATE` DATETIME /* CONSTRAINT "F_PMU_START_DATE_NN" */ NOT NULL,
    `END_DATE` DATETIME,
    `GIVE_AWAY` VARCHAR(80),
     /* Name ignored: CONSTRAINT `F_PMU_CODE_PK` */ PRIMARY KEY (`CODE`)
   );
...
CREATE TABLE  `F_REGULAR_MENUS`
   (`CODE` VARCHAR(3),
    ...
    `HOURS_SERVED` VARCHAR(30) /* CONSTRAINT "F_RMU_HOURS_SERVED_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_RMU_CODE_PK` */ PRIMARY KEY (`CODE`)
   );

CREATE TABLE  `F_FOOD_ITEMS`
   (`FOOD_ITEM_NUMBER` INT,
    `DESCRIPTION` VARCHAR(100) /* CONSTRAINT "F_FIM_DESC_NN" */ NOT NULL,
    `PRICE` DECIMAL(8,2) /* CONSTRAINT "F_FIM_PRICE_NN" */ NOT NULL,
    `REGULAR_CODE` VARCHAR(3),
    `PROMO_CODE` VARCHAR(3),
     /* Name ignored: CONSTRAINT `F_FIM_FOOD_ITEM_NUMBER_PK` */ PRIMARY KEY (`FOOD_ITEM_NUMBER`)
   );
...
CREATE TABLE  `F_STAFFS`
   (`ID` INT,
    ...
    `BIRTHDATE` DATETIME /* CONSTRAINT "F_STF_BIRTHDATE_NN" */ NOT NULL,
    `SALARY` DECIMAL(8,2) /* CONSTRAINT "F_STF_SALARY_NN" */ NOT NULL,
    `OVERTIME_RATE` DECIMAL(5,2),
    `TRAINING` VARCHAR(50),
    `STAFF_TYPE` VARCHAR(20) /* CONSTRAINT "F_STF_STAFF_TYPE_NN" */ NOT NULL,
    `MANAGER_ID` INT,
    `MANAGER_BUDGET` DECIMAL(8,2),
    `MANAGER_TARGET` DECIMAL(8,2),
     /* Name ignored: CONSTRAINT `F_STF_ID_PK` */ PRIMARY KEY (`ID`)
   );

CREATE TABLE  `F_ORDERS`
   (`ORDER_NUMBER` INT,
    `ORDER_DATE` DATETIME /* CONSTRAINT "F_ODR_ORDER_DATE_NN" */ NOT NULL,
    `ORDER_TOTAL` DECIMAL(8,2),
    `CUST_ID` INT /* CONSTRAINT "F_ODR_CUST_ID_NN" */ NOT NULL,
    `STAFF_ID` INT /* CONSTRAINT "F_ODR_STAFF_ID_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_ODR_ORDER_NUMBER_PK` */ PRIMARY KEY (`ORDER_NUMBER`)
   );

CREATE TABLE  `F_ORDER_LINES`
   (`ORDER_NUMBER` INT,
    `FOOD_ITEM_NUMBER` INT,
    `QUANTITY` SMALLINT /* CONSTRAINT "F_OLE_QUANTITY_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_OLE_PK` */ PRIMARY KEY (`ORDER_NUMBER`, `FOOD_ITEM_NUMBER`)
   );

CREATE TABLE  `F_SHIFTS`
   (`CODE` INT,
    `DESCRIPTION` VARCHAR(100) /* CONSTRAINT "F_SFT_DESC_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_SFT_CODE_PK` */ PRIMARY KEY (`CODE`)
   );

CREATE TABLE  `F_SHIFT_ASSIGNMENTS`
   (`CODE` INT,
    `ID` INT,
    `SHIFT_ASSIGN_DATE` DATETIME /* CONSTRAINT "F_SAT_SHIFT_ASSIGN_DATE_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `F_SAT_PK` */ PRIMARY KEY (`CODE`, `ID`)
   );
...
--  SQLINES DEMO *** onal_menus table
INSERT INTO f_promotional_menus(code,name,start_date,end_date,give_away)
VALUES('100','Back to School',STR_TO_DATE('09-01-2004','%m-%d-%Y'),STR_TO_DATE('09-30-2004','%m-%d-%Y'),'ballpen and highlighter');
INSERT INTO f_promotional_menus(code,name,start_date,end_date,give_away)
VALUES('110','Valentines Special',STR_TO_DATE('02-10-2004','%m-%d-%Y'),STR_TO_DATE('02-15-2004','%m-%d-%Y'),'small box of chocolates');
--  SQLINES DEMO *** _menus table
INSERT INTO f_regular_menus(code,type,hours_served)
VALUES('10','Breakfast','6-11am');
INSERT INTO f_regular_menus(code,type,hours_served)
VALUES('20','Lunch/Dinner','11-9pm');
--  SQLINES DEMO *** ems table
...
VALUES(12,'Sue','Doe',STR_TO_DATE('07-01-1980','%m-%d-%Y'),6.75,10.25,NULL,'Order Taker',19,NULL,NULL);
INSERT INTO f_staffs(id,first_name,last_name,birthdate,salary,overtime_rate,training,staff_type,manager_id,manager_budget,manager_target)
VALUES(9,'Bob','Miller',STR_TO_DATE('03-19-1979','%m-%d-%Y'),10,NULL,'Grill','Cook',19,NULL,NULL);
INSERT INTO f_staffs(id,first_name,last_name,birthdate,salary,overtime_rate,training,staff_type,manager_id,manager_budget,manager_target)
VALUES(19,'Monique','Tuttle',STR_TO_DATE('03-30-1969','%m-%d-%Y'),60,NULL,NULL,'Manager',NULL,50000,70000);
--  SQLINES DEMO *** table
INSERT INTO f_orders(order_number,order_date,order_total,cust_id,staff_id)
VALUES(5678,STR_TO_DATE('12-10-2002','%m-%d-%Y'),103.02,123,12);
--  SQLINES DEMO *** ines table
...
--  SQLINES DEMO *** ssignments table
INSERT INTO f_shift_assignments(code,id,shift_assign_date)
VALUES(1,12,STR_TO_DATE('05-06-2004','%m-%d-%Y'));
...
CREATE TABLE  `D_CDS`
   (`CD_NUMBER` INT,
    ...
    `YEAR` VARCHAR(4) /* CONSTRAINT "D_CDS_YEAR_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_CDS_CD_NUMBER_PK` */ PRIMARY KEY (`CD_NUMBER`)
   );
...
CREATE TABLE  `D_CLIENTS`
   (`CLIENT_NUMBER` INT,
    ...
    `PHONE` BIGINT /* CONSTRAINT "D_CLT_PHONE_NN" */ NOT NULL,
    `EMAIL` VARCHAR(50),
     /* Name ignored: CONSTRAINT `D_CLT_CLIENT_NUMBER_PK` */ PRIMARY KEY (`CLIENT_NUMBER`)
   );

CREATE TABLE  `D_PACKAGES`
   (`CODE` BIGINT,
    `LOW_RANGE` INT /* CONSTRAINT "D_PKE_LOW_RANGE_NN" */ NOT NULL,
    `HIGH_RANGE` INT /* CONSTRAINT "D_PKE_HIGH_RANGE_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_PKE_CODE_PK` */ PRIMARY KEY (`CODE`)
   );

CREATE TABLE  `D_THEMES`
   (`CODE` BIGINT,
    `DESCRIPTION` VARCHAR(100) /* CONSTRAINT "D_TME_DESC_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_TME_CODE_PK` */ PRIMARY KEY (`CODE`)
   );
...
CREATE TABLE  `D_VENUES`
   (`ID` INT,
    ...
    `COMMENTS` VARCHAR(100),
     /* Name ignored: CONSTRAINT `D_VNE_ID_PK` */ PRIMARY KEY (`ID`)
   );

CREATE TABLE  `D_EVENTS`
   (`ID` INT,
    `NAME` VARCHAR(50) /* CONSTRAINT "D_EVE_NAME_NN" */ NOT NULL,
    `EVENT_DATE` DATETIME /* CONSTRAINT "D_EVE_EVENT_DATE_NN" */ NOT NULL,
    `DESCRIPTION` VARCHAR(50),
    `COST` DECIMAL(8,2) /* CONSTRAINT "D_EVE_COST_NN" */ NOT NULL,
    `VENUE_ID` INT /* CONSTRAINT "D_EVE_VENUE_ID_NN" */ NOT NULL,
    `PACKAGE_CODE` BIGINT /* SQLines: Changed to match the PK data type */ /* CONSTRAINT "D_EVE_PACKAGE_CODE_NN" */ NOT NULL,
    `THEME_CODE` BIGINT /* CONSTRAINT "D_EVE_THEME_CODE_NN" */ NOT NULL,
    `CLIENT_NUMBER` INT /* CONSTRAINT "D_EVE_CLIENT_NUMBER_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_EVE_ID_PK` */ PRIMARY KEY (`ID`)
   );
...
CREATE TABLE  `D_PARTNERS`
   (`ID` INT,
    ...
    `AUTH_EXPENSE_AMT` DECIMAL(8,2),
    `MANAGER_ID` INT,
    `PARTNER_TYPE` VARCHAR(25) /* CONSTRAINT "D_PTR_PARTNER_TYPE_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_PTR_ID_PK` */ PRIMARY KEY (`ID`)
   );

CREATE TABLE  `D_JOB_ASSIGNMENTS`
   (`PARTNER_ID` INT,
    `EVENT_ID` INT,
    `JOB_DATE` DATETIME /* CONSTRAINT "D_JAT_JOB_DATE_NN" */ NOT NULL,
    `STATUS` VARCHAR(50),
     /* Name ignored: CONSTRAINT `D_JAT_PK` */ PRIMARY KEY (`PARTNER_ID`, `EVENT_ID`)
   );

CREATE TABLE  `D_TYPES`
   (`CODE` BIGINT,
    `DESCRIPTION` VARCHAR(50) /* CONSTRAINT "D_TPE_DESC_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_TPE_CODE_PK` */ PRIMARY KEY (`CODE`)
   );
...
CREATE TABLE  `D_SONGS`
   (`ID` INT,
    ...
    `DURATION` VARCHAR(20),
    `ARTIST` VARCHAR(20),
    `TYPE_CODE` BIGINT /* SQLines: Changed to match the PK data type */ /* CONSTRAINT "D_SNG_TYPE_CODE_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_SNG_ID_PK` */ PRIMARY KEY (`ID`)
   );
...
CREATE TABLE  `D_PLAY_LIST_ITEMS`
   (`EVENT_ID` INT,
    `SONG_ID` INT,
    `COMMENTS` VARCHAR(80),
     /* Name ignored: CONSTRAINT `D_PLM_PK` */ PRIMARY KEY (`EVENT_ID`, `SONG_ID`)
   );

CREATE TABLE  `D_TRACK_LISTINGS`
   (`SONG_ID` INT,
    `CD_NUMBER` INT,
    `TRACK` TINYINT /* CONSTRAINT "D_TLG_TRACK_NUMBER_NN" */ NOT NULL,
     /* Name ignored: CONSTRAINT `D_TLG_PK` */ PRIMARY KEY (`SONG_ID`, `CD_NUMBER`)
   );
...
VALUES(5922,100,'Peters Graduation',STR_TO_DATE('05-14-2004','%m-%d-%Y'),'Party for 200, red, white, blue motif',8000,100,112,200);
INSERT INTO d_events(client_number,id,name,event_date,description,cost,venue_id,package_code,theme_code)
VALUES(6133,105,'Vigil wedding',STR_TO_DATE('04-28-2004','%m-%d-%Y'),'Black tie at Four Season hotel',10000,220,200,200);
...
VALUES(11,105,STR_TO_DATE('02-02-2004','%m-%d-%Y'),'Visited');
...
CREATE TABLE  `REGIONS`
   (`REGION_ID` BIGINT /* CONSTRAINT "REGION_ID_NN" */ NOT NULL,
    `REGION_NAME` VARCHAR(25),
    /* Name ignored: CONSTRAINT `REG_ID_PK` */ PRIMARY KEY (`REGION_ID`)
   );
...
CREATE TABLE  `COUNTRIES`
   (`COUNTRY_ID` CHAR(2) /* CONSTRAINT "COUNTRY_ID_NN" */ NOT NULL,
    ...
    `REGION_ID` BIGINT /* SQLines: Changed to match the PK data type */,
     /* Name ignored: CONSTRAINT `COUNTRY_C_ID_PK` */ PRIMARY KEY (`COUNTRY_ID`)
   );
...
CREATE TABLE  `LOCATIONS`
   (`LOCATION_ID` SMALLINT,
    ...
    `COUNTRY_ID` CHAR(2),
    /* Name ignored: CONSTRAINT `LOC_ID_PK` */ PRIMARY KEY (`LOCATION_ID`)
   );
...
CREATE TABLE  `DEPARTMENTS`
   (`DEPARTMENT_ID` SMALLINT,
    ...
    `MANAGER_ID` INT,
    `LOCATION_ID` SMALLINT,
     /* Name ignored: CONSTRAINT `DEPT_ID_PK` */ PRIMARY KEY (`DEPARTMENT_ID`)
   );
...
CREATE TABLE  `JOBS`
   (`JOB_ID` VARCHAR(10),
    ...
    `MIN_SALARY` INT,
    `MAX_SALARY` INT,
     /* Name ignored: CONSTRAINT `JOB_ID_PK` */ PRIMARY KEY (`JOB_ID`)
   );
...
CREATE TABLE  `EMPLOYEES`
   (`EMPLOYEE_ID` INT,
	...
	`BONUS` VARCHAR(5),
     ...
     /* Name ignored: CONSTRAINT `EMP_ID_PK` */ PRIMARY KEY (`EMPLOYEE_ID`)
 ,
     /* Name ignored: CONSTRAINT `EMP_EMAIL_UK` */ UNIQUE (`EMAIL`)
  );
...
CREATE TABLE  `JOB_GRADES`
   (`GRADE_LEVEL` VARCHAR(3),
    `LOWEST_SAL` DECIMAL(18,6),
    `HIGHEST_SAL` DECIMAL(18,6)
   );
...
CREATE TABLE  `JOB_HISTORY`
   (`EMPLOYEE_ID` INT /* CONSTRAINT "JHIST_EMPLOYEE_NN" */ NOT NULL,
    ...
    `DEPARTMENT_ID` SMALLINT,
     ...
     /* Name ignored: CONSTRAINT `JHIST_EMP_ID_ST_DATE_PK` */ PRIMARY KEY (`EMPLOYEE_ID`, `START_DATE`)
   );
...
-- department 190 tetap NULL


--  SQLINES DEMO *** ry table
...
-- SQLINES DEMO ***  they exist	
CALL DropSequence('`DEPARTMENTS_SEQ`');
CALL DropSequence('`EMPLOYEES_SEQ`');
CALL DropSequence('`LOCATIONS_SEQ`');

--  SQLINES DEMO *** r departments PK				
CALL CreateSequence('`DEPARTMENTS_SEQ`', 280, 10)  
  ;

--  SQLINES DEMO *** r employees PK	
CALL CreateSequence('`EMPLOYEES_SEQ`', 207, 1)  
  ;

--  SQLINES DEMO *** r locations PK	
CALL CreateSequence('`LOCATIONS_SEQ`', 3300, 100)  
   ;

EXPLAIN SELECT * FROM EMPLOYEES WHERE SALARY > 5000;

LOCK TABLE f_customers READ;
DELETE FROM f_customers WHERE CITY = 'Semarang';
UNLOCK TABLE;
DELETE FROM f_customers WHERE CITY = 'Semarang';
...
UPDATE employees
SET salary = 36000,
    phone_number = '619.123.0000'
WHERE employee_id = 100;

TRUNCATE TABLE f_customer;
select * FROM F_CUSTOMER;

ALTER TABLE f_customers RENAME TO F_CLIENTS; SELECT * FROM F_CLIENTS
